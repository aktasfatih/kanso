...
class SettingsControllerTest extends TestCase {
	...
	public function testIndexReturnsStoredBoardId(): void {
		...
		self::assertSame(
			['defaultBoardId' => 42, 'collapsedBoardGroups' => [], 'dismissedHints' => [], 'hiddenNavSections' => []],
	...
	public function testIndexReturnsNullWhenUnset(): void {
		...
		self::assertSame(
			['defaultBoardId' => null, 'collapsedBoardGroups' => [], 'dismissedHints' => [], 'hiddenNavSections' => []],
			$this->controller->index()->getData()
		);
	}
	...
	public function testIndexReturnsCollapsedGroups(): void {
		...
		self::assertSame(
			['defaultBoardId' => null, 'collapsedBoardGroups' => [3, 7], 'dismissedHints' => [], 'hiddenNavSections' => []],
			$this->controller->index()->getData()
		);
	}
	...
	public function testUpdatePersistsBoardId(): void {
		...
		self::assertSame(
			['defaultBoardId' => 7, 'collapsedBoardGroups' => [], 'dismissedHints' => [], 'hiddenNavSections' => []],
